...
elseif IntegFormu == 200
 ...
 elseif IntegFormu == 500
  ...
  elseif IntegFormu == 600 
    % % % % % beam contact the circular rigid body ***************************************
    u0 = y0(1:ndof);                             %% Iniatial coordinates
    v0 = y0(ndof+1:2*ndof);                      %% Initial velocities
    [t,u,v]=odeSemiFE_beam_to_circle(tspan, u0, v0,ElemDofs,rho,g,lambda,G,L/n,H,W,ee0bc,ee0dotbc,bcInd,xloc,nl,nx,ndof,bc,MgcInvs,mu,DIM,nc,Nk,xi,r);
    y=[u',v'];
